    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-slate-950 text-slate-900 dark:text-white font-sans flex flex-col animate-in fade-in duration-1000">
      ...
      <main className="flex-grow">
        ...
        <section className="max-w-7xl mx-auto px-8 py-24 text-center">
          <span className="px-6 py-2 bg-white border-2 border-slate-900 rounded-full font-black uppercase italic text-[10px] shadow-[4px_4px_0px_0px_#0B8ED9] mb-8 inline-block text-slate-900">
            Get In Touch
          </span>
        ...
        <section className="max-w-7xl mx-auto px-8 pb-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className="bg-white dark:bg-slate-900 border-4 border-slate-900 dark:border-white p-10 md:p-14 rounded-[3.5rem] shadow-[20px_20px_0px_0px_rgba(15,23,42,1)]">
              ...
              <form ref={formRef} onSubmit={sendEmail} className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[#F8FAFC] dark:bg-slate-800 border-4 border-slate-900 dark:border-white p-6 rounded-3xl font-bold italic outline-none focus:shadow-[6px_6px_0px_0px_#0B8ED9] transition-all text-slate-900 dark:text-white"
                  ></textarea>
                </div>
                <button 
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#0B8ED9] text-white py-6 rounded-3xl font-black uppercase italic text-xl border-4 border-slate-900 shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all flex items-center justify-center gap-4 group disabled:opacity-50"
                >
            ...
            <div className="flex flex-col gap-10">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="flex-grow bg-slate-900 rounded-[3.5rem] border-4 border-slate-900 relative overflow-hidden group shadow-[20px_20px_0px_0px_#0B8ED9] min-h-[300px] cursor-pointer"
              >
                <div className="absolute inset-0 bg-[#0B8ED9]/20 group-hover:bg-transparent transition-colors duration-700"></div>
                <div className="absolute inset-0 flex items-center justify-center text-center">
                    <div>
                        ...
                        <p className="text-[#0B8ED9] text-xs font-bold uppercase mt-2">Click to open Maps</p>
                    </div>
                </div>
              </a>
            </div>
      ...
      {/* 4. Professional Mega Footer (النسخة اللي طلبتها بالظبط) */}
...
function ContactInfoCard({ icon, title, detail, isLink, link }) {
  const content = (
    <div className="bg-white dark:bg-slate-900 border-4 border-slate-900 dark:border-white p-8 rounded-[2.5rem] shadow-[10px_10px_0px_0px_#0B8ED9] hover:translate-y-[-5px] transition-transform h-full">
